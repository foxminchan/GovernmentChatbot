...
export const targetGroupOrganization = [
    ...
    { name: 'DOANH NGHIỆP', link: '/doanh-nghiep', key: 'business' },
  ];
export const hostNewsData=[
  {id:'1', content:'Nộp Lệ phí trước bạ và thuế cá nhân trên Cổng Dịch vụ công quốc gia',date:'Ngày 09/12/2021'},
  {id:'2', content:'Cung cấp 7 dịch vụ công hỗ trợ đối tượng gặp khó khăn do đại dịch Covid-19 trên Cổng Dịch vụ công Quốc gia',date:'Ngày 03/08/2021'},
  {id:'3', content:'Lợi ích 5K khi thanh toán thuế, phí trước bạ đất đai trên Cổng Dịch vụ công quốc gia',date:'Ngày 09/06/2021'},
  {id:'4', content:'Thông báo bảo trì, nâng cấp Hệ thống bên CSGT',date:'Ngày 21/07/2023'},
  {id:'5', content:'Hướng dẫn khắc phục lỗi khi đăng ký tài khoản trên Cổng Dịch vụ công quốc gia',date:'Ngày 29/07/2022'},
  {id:'6', content:'Cung cấp dịch vụ công \'Giải quyết hưởng trợ cấp thất nghiệp\' trên Cổng Dịch vụ công quốc gia',date:'Ngày 22/04/2022'},
];
...
export const itemGuide = [
  {
    ...
    content: 'Người dân, doanh nghiệp có 3 cách để tiếp cận thủ tục hành chính, dịch vụ công, đó là:\n'+
  ...
  },
  {
    ...
    content: 'Căn cứ vào “Cơ quan thực hiện” trong thông tin thủ tục hành chính, người dân, doanh nghiệp chọn cơ quan thực hiện tương ứng của thủ tục cần thực hiện',
  ...
  },
  {
    ...
    content: 'Người dân, doanh nghiệp có thể đăng ký tài khoản bằng: Sim ký số; USB ký số; Thuê bao di động (Dành cho Công dân); Mã số BHXH (Dành cho Công dân).\n' +
  ...
  },
  {
    ...
    content: 'Sau khi Người dân, doanh nghiệp đăng nhập thành công, Cổng Dịch vụ công Quốc gia sẽ điều hướng về Cổng của Bộ/Ngành/Địa phương nơi mà người dân, doanh nghiệp đăng ký thực hiện thủ tục để nộp hồ sơ.\n' +
